            ...
            <div className={classes.containerInside}>
                ...
                <div className={classes.inside}>
                    <div className={classes.singleOther}>
                        ...
                        <div className={classes.singleTitle}>Describe Order</div>
                        <div className={classes.singleOtherText}>Pick date upon availability new to call Makesy
                    ...
                    <div className={classes.singleOther}>
                        ...
                        <div className={classes.singleTitle}>Sourcing</div>
                        <div className={classes.singleOtherText}>Shipment tracking, estimated delivery dates, and
                            frequent updates on the order status</div>
                    </div>
                    ...
                    <div className={classes.singleOther}>
                        ...
                        <div className={classes.singleTitle}>Measure and fitting</div>
                    ...
                    <div className={classes.singleOther}>
                        ...
                        <div className={classes.singleTitle}>Communication</div>
                        <div className={classes.singleOtherText}>Add your Team members, get them involved with the
                            calls, and keep them updated with the order status</div>
                    </div>
                </div>
            </div>
        </div>
